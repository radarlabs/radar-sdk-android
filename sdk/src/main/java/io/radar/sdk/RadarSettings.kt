...
internal object RadarSettings {
    ...
    internal fun updateSessionId(context: Context): Boolean {
        ...
        if (timestampSeconds - sessionIdSeconds > 300) {
            ...
            Radar.logger.d("New session", "sessionId" to this.getSessionId(context))
            return true
        }
        return false
    }
    ...
    internal fun setId(context: Context, id: String?) {
        getSharedPreferences(context).edit { putString(KEY_ID, id) }
    }
