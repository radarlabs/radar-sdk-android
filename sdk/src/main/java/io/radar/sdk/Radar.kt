...
object Radar {
     ...
     */
    @JvmStatic
    fun logConversion(name: String, data: JSONObject?, callback: RadarLogConversionCallback) {
        if (!initialized) {
            callback.onComplete(RadarStatus.ERROR_PUBLISHABLE_KEY)
    ...
    fun logConversion(
        ...
        logConversion(name, nonNullData, callback)
    }
    ...
    fun logConversion(
        ...
        logConversion(name, data, object : RadarLogConversionCallback {
            override fun onComplete(
                status: RadarStatus,
                location: Location?,
                events: Array<RadarEvent>?,
    ...
    fun logConversion(
        ...
        logConversion(name, location, data, object : RadarLogConversionCallback {
            override fun onComplete(
                status: RadarStatus,
                location: Location?,
                events: Array<RadarEvent>?,
