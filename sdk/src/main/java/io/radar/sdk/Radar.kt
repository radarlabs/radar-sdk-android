...
object Radar {
     ...
     *
     * @param[customType] The name of the conversion.
     * @param[data] The metadata associated with the conversion.
     * @param[callback] A callback.
     */
    @JvmStatic
    fun logConversion(customType: String, data: JSONObject?, callback: RadarLogConversionCallback) {
        if (!initialized) {
            callback.onComplete(RadarStatus.ERROR_PUBLISHABLE_KEY)
        ...
        trackOnce(object : RadarTrackCallback {
            override fun onComplete(status: RadarStatus, location: Location?, events: Array<RadarEvent>?, user: RadarUser?) {
                ...
                logConversion(customType, data, location, events, user, callback)
            }
        })
    }
    ...
    fun logConversion(
        ...
        logConversion(customType, data, object : RadarLogConversionCallback {
            override fun onComplete(
                status: RadarStatus,
                location: Location?,
                events: Array<RadarEvent>?,
    ...
    fun logConversion(
        ...
        logConversion(customType, location, data, object : RadarLogConversionCallback {
            override fun onComplete(
                status: RadarStatus,
                location: Location?,
                events: Array<RadarEvent>?,
