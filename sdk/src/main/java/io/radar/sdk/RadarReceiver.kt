...
/**
 * A receiver for client-side delivery of events, location updates, and debug logs. For more information,
...
abstract class RadarReceiver {
    ...
    /**
     * Tells the receiver that client's location was updated but not necessarily synced to the server. To receive
     * server-synced location updates and user state, use [onLocationUpdated] instead.
     *
     * @param[context] The context.
     * @param[location] The location.
     ...
     */
    abstract fun onClientLocationUpdated(
        context: Context,
        location: Location,
        stopped: Boolean,
