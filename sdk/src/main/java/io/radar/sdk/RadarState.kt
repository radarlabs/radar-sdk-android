...
internal class RadarState(private val context: Context) {
    ...
    internal fun getLastMovedLocation(): Location? {
        ...
        val lastMovedLocationLatitude = prefs.getFloat(KEY_LAST_MOVED_LOCATION_LATITUDE, 0f)
        val lastMovedLocationLongitude = prefs.getFloat(KEY_LAST_MOVED_LOCATION_LONGITUDE, 0f)
        val lastMovedLocationAccuracy = prefs.getFloat(KEY_LAST_MOVED_LOCATION_ACCURACY, 0f)
        val lastMovedLocationProvider = prefs.getString(KEY_LAST_MOVED_LOCATION_PROVIDER, "RadarSDK")
        val lastMovedLocationTime = prefs.getLong(KEY_LAST_MOVED_LOCATION_TIME, 0L)
    ...
    internal fun getLastFailedStoppedLocation(): Location? {
        ...
        val lastFailedStoppedLocationProvider = prefs.getString(KEY_LAST_FAILED_STOPPED_LOCATION_PROVIDER, "RadarSDK")
