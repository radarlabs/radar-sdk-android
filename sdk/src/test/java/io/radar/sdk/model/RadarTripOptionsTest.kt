...
class RadarTripOptionsTest {
    ...
    fun testToFromJsonWithNonZeroApproachingThreshold() {
        val tripOptions = RadarTripOptions(
            externalId = "externalId", destinationGeofenceTag = "destinationGeofenceTag", destinationGeofenceExternalId = "destinationGeofenceExternalId", approachingThreshold = 5
        )
    ...
    fun testToFromJsonWithZeroApproachingThresholdIgnoresThreshold() {
        val tripOptions = RadarTripOptions(
            externalId = "externalId", destinationGeofenceTag = "destinationGeofenceTag", destinationGeofenceExternalId = "destinationGeofenceExternalId", approachingThreshold = 0 // values less than 1 aren't serialized
        )
        val jsonObject = tripOptions.toJson()
    ...
    fun testToFromJsonWithNegativeApproachingThresholdIgnoresThreshold() {
        val tripOptions = RadarTripOptions(
            externalId = "externalId", destinationGeofenceTag = "destinationGeofenceTag", destinationGeofenceExternalId = "destinationGeofenceExternalId", approachingThreshold = -5 // negative values aren't serialized
        )
        val jsonObject = tripOptions.toJson()
    ...
    fun testIsEqualsWithDifferentApproachingThresholdsReturnsFalse() {
        ...
        val tripOptions2 = RadarTripOptions(
            externalId = "externalId", destinationGeofenceTag = "destinationGeofenceTag", destinationGeofenceExternalId = "destinationGeofenceExternalId", approachingThreshold = 11
        )
    ...
    fun testIsEqualsWithUnsetApproachingThresholdsReturnsFalse() {
        val tripOptions1 = RadarTripOptions(
            externalId = "externalId", destinationGeofenceTag = "destinationGeofenceTag", destinationGeofenceExternalId = "destinationGeofenceExternalId"
        )
