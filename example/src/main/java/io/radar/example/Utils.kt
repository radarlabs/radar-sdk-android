    ...
    companion object {
        ...
        fun stringForRadarStatus(status: Radar.RadarStatus): String {
            return when (status) {
                ...
                Radar.RadarStatus.ERROR_PAYMENT_REQUIRED -> "Payment required error"
                Radar.RadarStatus.ERROR_FORBIDDEN -> "Forbidden error"
                Radar.RadarStatus.ERROR_NOT_FOUND -> "Not found error"
                Radar.RadarStatus.ERROR_PLUGIN -> "Plugin error"
