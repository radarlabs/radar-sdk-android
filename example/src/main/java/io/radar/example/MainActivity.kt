...
const val permissionsRequestCode = 52456
...
//        }
    ...
    private fun updateUI(radarLocationPermissionsManager: RadarLocationPermissionsManager){
        // update the UI based on the permissions status
        val titleTextView = findViewById<TextView>(R.id.titleTextView)
        val descriptionTextView = findViewById<TextView>(R.id.descriptionTextView)
        val myButton = findViewById<Button>(R.id.myButton)
        val state = radarLocationPermissionsManager.getPermissionsStatus()
         when (state.status) {
        RadarLocationPermissionsStatus.PermissionStatus.NO_PERMISSIONS_GRANTED -> {
            ...
            myButton.setOnClickListener {
                // Code to request permissions
                radarLocationPermissionsManager.requestForegroundPermissions()
                updateUI(radarLocationPermissionsManager)
            }
        }
        ...
        RadarLocationPermissionsStatus.PermissionStatus.FOREGROUND_PERMISSIONS_GRANTED -> {
            ...
            myButton.setOnClickListener {
                radarLocationPermissionsManager.requestBackgroundPermissions()
            }
        }
